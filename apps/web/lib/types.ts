...
export type Risk = {
  ...
  target_benefit: number | null;
  existing_controls: string | null;
  control_effectiveness_desc: string | null;
  // Inherent Risk
  impact_desc: string | null;
  frequency_desc: string | null;
  inherent_risk_desc: string | null;
  // Residual Risk
  control_score: number | null;
  control_effectiveness_label: string | null;
  residual_risk_desc: string | null;
  // Action Plan
...
export type Document = {
  id: string; org_id: string; doc_number: number;
  title: string; description: string | null;
  doc_type: string; category: string | null;
  status: string; classification: string | null;
  current_version: string;
  owner: string | null; reviewer: string | null; approver: string | null;
  effective_date: string | null; next_review_date: string | null;
  linked_frameworks: string | null;
  owner_user_id: string | null;
