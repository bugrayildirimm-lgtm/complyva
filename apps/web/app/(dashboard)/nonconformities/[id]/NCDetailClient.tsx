...
export default function NCDetailClient({
  ...
  const sentToCAPA = crossLinks.some((l: any) => l.source_type === "NC" && l.target_type === "CAPA" && l.link_type === "GENERATED");
    ...
    <>
      ...
      <div className="page-header">
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          {canEdit && (sentToCAPA ? (
            <span style={{ fontSize: 12, color: "#22c55e", fontWeight: 600 }}>✓ Sent to CAPA</span>
          ) : (
          <ConfirmAction
            trigger={
      ...
      <div className="card">
        ...
        <ApprovalPanel entityType="NC" entityId={nc.id} entityStatus={nc.status} onStatusChange={() => router.refresh()} />
      </div>
    </>
  );
}
