...
export default function IncidentDetailClient({
  ...
  const sentToRisk = crossLinks.some((l: any) => l.source_type === "INCIDENT" && l.target_type === "RISK" && l.link_type === "GENERATED");
  const sentToNC = crossLinks.some((l: any) => l.source_type === "INCIDENT" && l.target_type === "NC" && l.link_type === "GENERATED");
    ...
    <>
      ...
      <div className="page-header">
        ...
        {canEdit && <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          {sentToRisk ? (
            <span style={{ fontSize: 12, color: "#22c55e", fontWeight: 600 }}>✓ Sent to Risk</span>
          ) : (
          <ConfirmAction
            trigger={
          ...
          {sentToNC ? (
            <span style={{ fontSize: 12, color: "#22c55e", fontWeight: 600 }}>✓ Sent to NC</span>
          ) : (
          <ConfirmAction
            trigger={
              <button disabled={isPending}
      ...
      <div className="card">
        ...
        <ApprovalPanel entityType="INCIDENT" entityId={incident.id} entityStatus={incident.status} onStatusChange={() => router.refresh()} />
      </div>
    </>
  );
}
