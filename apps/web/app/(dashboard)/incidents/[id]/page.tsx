import { getIncident, getAssets, getEvidence, getEntityActivity, getEntityCrossLinks, updateIncident, deleteIncident, sendIncidentToRisk, sendIncidentToNC, uploadEvidence, deleteEvidence } from "../../../../lib/api";
